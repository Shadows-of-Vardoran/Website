...
<div class="flex gap-6 my-4">
  <div class="flex-1 text-lg leading-relaxed">
    <p class="mb-1 font-cinzel text-tprimary-100">
      But the war had not left the world unchanged.
    </p>
    <p class="mb-4">
      The theories are many, and none have been proven. Some believe the land itself absorbed the magical conflict and reached a breaking point, that the world was saturated with power it had never been meant to hold and simply gave way. Others are convinced Dracula never truly died, that whatever he became after Dracula's Demise is still out there, and the magic bleeding into the world is his continued influence seeping through from wherever he went. Some turn their suspicion toward the Church of Luminance, whispering that light magic was never a gift but a bargain, and that something, somewhere, is still collecting on it. And there are those who believe magic was never introduced at all, that it was always here, sleeping beneath the surface, and the war simply woke it up.
    </p>
    <p class="font-cinzel italic text-tprimary-400">
...
<div class="flex flex-row-reverse gap-6 my-4">
  <div class="flex-1 text-lg leading-relaxed">
    ...
    <p class="font-cinzel text-xl text-tprimary-50">
      You are one of them.
    </p>
  </div>
...
<div class="text-lg leading-relaxed">
  <p class="mb-4">
    Beyond the borders of nations, factions and orders pursue their own agendas in Vardoran and beyond. Some serve the public good. Others serve only themselves. Whether they operate in the open or in the shadows, their influence reaches every corner of the known world.
  </p>
</div>
