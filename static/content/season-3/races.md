...
- Sunlight settings are more brutal than normal.
  </div>
  <div class="p-4 rounded bg-background-800/60 border border-tprimary-900/30">
...
Humans who survive long enough to increase their blood percentage will be given progression quests tied to their current blood level. Each quest advances you into the next range. For example, if you are in your 30s, completing the First Steps quest raises you into your 40s.
...
- May begin with a nature citizenship, making them non-hostile to most animals and elementals.
  </div>
</div>
